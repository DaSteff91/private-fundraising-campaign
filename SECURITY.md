...
- [ ] Use a real `.env`; never commit it. Rebuild after payee, Impressum, or campaign env changes (`npm run build` bakes them into `dist/`).
...
- [ ] Superuser: strong unique password. In PocketBase Settings, disable public user registration.
